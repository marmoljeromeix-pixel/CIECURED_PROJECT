...
var TRANSLATIONS = {
  tl: {
    ...
    "rights.ra11313.main": "Sakop nito ang Pamimilit sa mga kalye, pampublikong lugar, online, at sa paaralan o pinagtatrabahuhan — anumang uri ng Pamimilit na nakabatay sa kasarian.",
    "rights.ra11313.extra": "Kabilang dito ang catcalling, stalking, hindi hinihinging pang-aakit, at online na Pamimilit tulad ng hindi hinihinging sekswal na komento, banta, o pagbahagi ng pribadong nilalaman nang walang pahintulot.",
    "rights.ra7877.title": "Batas Kontra sa Sekswal na Pamimilit (Anti-Sexual Harassment Act)",
    "rights.ra7877.main": "Tumutugon ito sa Pamimilit ng isang taong may awtoridad, impluwensya, o moral na impluwensya (moral ascendancy) sa iyo, sa paaralan man o sa trabaho.",
    ...
    "chip.reporting": "Pag-report",
    "chip.safety": "Kaligtasan Muna",

    "nav.rights": "Alamin ang Iyong mga Karapatan",
    "nav.assess": "i-Assess ang Sarili",
    "nav.inbox": "Inbox",
    "nav.report": "Report",

    "hero.eyebrow": "LIGTAS · KUMPIDENSYAL · MAY PANANAGUTAN???",
    "hero.sub": "Isang ligtas at kumpidensyal na espasyo para sa mga estudyante ng CIE upang maunawaan ang kanilang mga karapatan, ilahad ang kanilang mga concern, at kumilos — na sila parin ang may kontrol ng kanilang sariling kwento.",
    "hero.reportnow": "Mag report Ngayon",
    "hero.noaccount": "Kailangan lamang ng TUP-ID para magsimula",
    "hero.trust1": "Anonymous o may pangalan",
    "hero.trust2": "Tamper-evident",
    "hero.trust3": "Audited access only",
    ...
    "hero.list3": "Sundin ang sarili mong oras — walang minamadali",
    ...
    "trust.card2.desc": "Bawat report at aksyon ay naitatala sa isang hash-chained na rekord na maaaring beripikahin nang independent.",
    ...
    "trust.card4.title": "Nandito lagi para sa iyo",
    "trust.card4.desc": "Magsimula ng report anumang oras. Hindi ito emergency line — kung may agarang panganib, tumawag sa iyong lokal na hotline. numero 911",

    "how.eyebrow": "⚙ Paano Gumagana ang CIEcured",
    "how.title": "Isang simple at secure na proseso ng pag-report",
    ...
    "how.step4.desc": "Gamitin ang iyong TUP-ID upang tingnan ang mga update at ipagpatuloy ang komunikasyon.",

    "report.eyebrow": "Mag-ulat ng Alalahanin",
    "report.title": "Kapag handa ka na, makikinig kami. ",
    ...
    "report.category.harassment":  "Pamimilit",
    "report.category.abuse": "Pisikal o emosyonal na pang-aabuso",
    "report.category.online": "Online / digital na Pamimilit",
    ...
    "ways.intro": "May karapatan kang magsalita at humingi ng tulong. May mga ligtas at angkop na channel na nariyan para sa iyo.",
    ...
    "ways.card2.desc": "Gamitin ang umiiral na proseso ng pag-report at mga serbisyo na suporta ng paaralan.",
    ...
    "assess.eyebrow": "🧭 i-Assess ang Sarili",
    "assess.title": "Gaano mo kaalam ang iyong mga karapatan?",
    "assess.intro": "Sampung mabilisang tanong — walang maling sagot, nililinaw lang. Wala sa mga ito ang sinusubaybayan o kinakalat kahit saan.",
    "assess.result.report": "Mag-report ng concern",
    ...
    "scenario.s1.title": "Ano ang gagawin mo kung may kaklase kang humawak sa iyo nang wala kang pahintulot?",
    "scenario.s1.preview": "Sa isang gawain sa klase, paulit-ulit na hinahawakan ng isang kaklase ang kapwa estudyante kahit malinaw namang ipinaalam nito na hindi ito komportable. Lumalayo ang estudyante, pero nauulit pa rin ito, at binabalewala lang bilang \"biro.\" Naiiwan ang estudyante na stress at nag-aalinlangan kung dapat itong i-report.",
    "scenario.s1.meaning": "Maaaring lumayo ang estudyante at lumapit sa taong pinagkakatiwalaan nito, tulad ng guro o ng tanggapan ng GAD (Gender and Development). Maaari nitong ibahagi ang nangyari at i-report ang pag-uugali sa oras na maging handa ito. Sa pamamagitan ng GAD, makakatanggap ito ng suporta at gabay habang ginagalang at pinananatiling kumpidensyal ang kanilang concern.",

    "scenario.s2.label": "Sa Loob ng Faculty",
    "scenario.s2.title": "Ano ang gagawin mo kung lumabag ang isang propesor sa personal mong boundary",
    "scenario.s2.preview": "Ang posisyon ng awtoridad ay hindi dapat gamitin upang pilitin o takutin ang isang estudyante.",
    "scenario.s2.meaning": "Ang hindi hinihinging komento, mensahe, o pamimilit mula sa taong may kapangyarihan sa iyong akademikong kalagayan ay isang maling paggamit ng awtoridad na iyon, hindi normal na bahagi ng pagtuturo. Ang hindi pagsunod na ito ay maaaring magpahirap sa pagtanggi o pag-report, lalo na kung nakataya ang mga marka o oportunidad — at ang pag-aalinlangang ito ay makatwirang tugon sa tunay na panganib, hindi tanda na hindi wasto ang concern.",

    "scenario.s3.label": "Buhay sa Online na Kampus",
    "scenario.s3.title": "Ano ang gagawin mo kung naging lugar ng Pangungutya ang inyong class group chat?",
    "scenario.s3.preview": "Ang Pambu-bully ay maaaring mangyari kahit nasa likod ka ng screen.",
    "scenario.s3.meaning": "Ang hindi hinihinging mensahe, ibinahaging larawan, tsismis, o masasama na biro sa isang class o organization chat ay Harrasment pa rin, kahit walang pisikal na presensya. Ang online na espasyo ay maaaring mas mahirap talikuran — maaari itong sumunod sa iyong mga notification anumang oras — at wala sa mga ito ang nagpapagaan sa bigat nito.",

    "scenario.s4.label": "Buhay Bilang Estudyante",
    "scenario.s4.title": "Ano ang gagawin mo kung may namimilit sa iyo na gumawa ng bagay na ayaw mo?",
    "scenario.s4.preview": "Hindi ka kailanman may utang na loob sa isang tao dahil siya ay kaibigan mo, kapareha, kaklase, o kasapi ng organisasyon.",
    "scenario.s4.meaning": "Ang pamimilit, panggigipit, paulit-ulit na pakikiusap, o pag-sasabi na \"lahat naman ay ginagawa ito\" ay maaaring magpahirap na magbigay ng tunay na malayang pagpayag. Ang pagsang-ayon lamang upang maiwasan ang alitan o hindi masali ay hindi katumbas ng tunay na pagnanais na sumang-ayon — at maaari kang magbago ng isip anumang oras, kahit pagkatapos mong sumang-ayon.",

    "scenario.s5.label": "Bilang Saksi",
    "scenario.s5.title": "Ano ang gagawin mo kung nasaksihan mong may hinaharras sa kampus?",
    "scenario.s5.preview": "Hindi mo kailangang maranasan mismo ang Pang-haharras upang makatulong lumikha ng mas ligtas na kampus.",
    "scenario.s5.meaning": "Ang pagpansin na may hindi tama ay kadalasang unang hakbang, kahit hindi ka pa lubos na sigurado kung ano talaga ang nangyayari. Hindi mo kailangang direktang manghimasok o magkaroon ng lahat ng sagot upang makatulong — minsan, ang pinakamalaking tulong ay ang simpleng pagtanong kung okay lang o pagtulong sa paghahanap ng suporta."
  }
};
...
// Holds the setInterval ID for auto-refreshing the currently open
// case, so we can stop it later (when the student locks/leaves the
// inbox). Without this, the student would only ever see a staff
// reply after manually refreshing and re-entering their TUP ID and
// password — this polls in the background instead, the same way the
// admin dashboard already does.
var THREAD_POLL_TIMER = null;
...
// Checks the server every few seconds for updates to the case that's
// currently open — a new staff reply, or a status change — without
// the student needing to refresh the page or re-enter their password.
function startThreadPolling(){
  stopThreadPolling();
  THREAD_POLL_TIMER = setInterval(refreshCurrentCase, 8000);
}

function stopThreadPolling(){
  if(THREAD_POLL_TIMER){
    clearInterval(THREAD_POLL_TIMER);
    THREAD_POLL_TIMER = null;
  }
}
...
function refreshCurrentCase(){
  ...
  var tupId = CURRENT_CASE;
  var password = sessionStorage.getItem('pw_' + tupId) || '';
  ...
  fetch('get_report.php', {
    ...
    .then(function(data){
      // If something went wrong, or the student has since moved to a
      // different case/page, just quietly skip this refresh instead
      // of showing an error — the next poll will try again.
      if(data.error || CURRENT_CASE !== tupId) return;
      ...
      var c = INBOX_CASES[tupId];
      var messageCountChanged = messages.length !== c.messages.length;
      var statusChanged = data.status !== c.status;

      c.messages = messages;
      c.status = data.status;
      c.resolutionNote = data.resolution_note || '';

      // Only touch the page if something actually changed, so we're
      // not needlessly re-rendering (and losing scroll position) every
      // 8 seconds for no reason.
      ...
      if(statusChanged){
        ...
        if(c.status === 'resolved' && c.resolutionNote){
          showResolvedModal(c.resolutionNote);
        }
      }
    })
    .catch(function(){
      // Silent on failure — this is a background refresh, not a
      // student-initiated action, so there's nothing useful to show
      // them if one check fails. It'll just try again on the next poll.
    });
}
...
function sendReply(e){
  ...
  // Send this message to the shared admin backend, so staff see it
  // on their dashboard too. We reuse the password this tab already
  // checked when the case was opened. The background polling this
  // page already does will pick up a real staff reply once one comes
  // in — there's no fake/simulated response here anymore.
...
var QUIZ = [
  {
    ...
    qTL:"Sa sitwasyon sa silid-aralan, patuloy na hinahawakan ng isang kaklase ang kapwa estudyante kahit malinaw na nailahad na nito na hindi ito komportable. Aling batas ang direktang sumasaklaw sa pamimilit na nagaganap sa isang institusyong pang-edukasyon tulad nito?",
    optionsTL:[
      "RA 9262 (Anti-VAWC Law)",
      "RA 11313 (Safe Spaces Act)",
      "RA 7877 (Anti-Sexual Harassment Act)",
    ...
    explainTL:"Malinaw na sinasaklaw ng RA 11313 (Safe Spaces Act) ang gender-based na Pamimilit sa mga kalye, pampublikong lugar, online, at sa paaralan o pinagtatrabahuhan — kabilang na ang sa pagitan ng magkapantay, hindi lamang sa mga estranghero."
  },
  {
  ...
  },
  {
    ...
    qTL:"Sa sitwasyon sa faculty, ginagamit ng isang propesor ang kanyang posisyon upang pilitin ang isang estudyante. Aling batas ang partikular na tumutugon sa panliligalig ng isang taong may awtoridad o moral ascendancy sa iba?",
    optionsTL:[
      "RA 9262 (Anti-VAWC Law)",
      "RA 11313 (Safe Spaces Act)",
      "RA 7877 (Anti-Sexual Harassment Act)",
    ...
    explainTL:"Tinutugunan ng RA 7877 (Anti-Sexual Harassment Act) ang Pamimilit ng isang taong may awtoridad, impluwensya, o moral ascendancy — tulad ng superbisor, adviser, o propesor — sa taong apektado."
  },
  {
    ...
    qTL:"Kung lumabag ang isang propesor sa personal na boundary, ano ang makatwirang hakbang na maaaring gawin ng estudyante?",
    optionsTL:[
  ...
  },
  {
    ...
    qTL:"Ipinapakita ng sitwasyong online na ginagamit ang class group chat upang kutyain ang isang estudyante. Aling batas ang partikular na nagpapalawig ng proteksyon laban sa pangungutya at paninira sa online na espasyo?",
    optionsTL:[
      "RA 9262 (Anti-VAWC Law)",
      "RA 11313 (Safe Spaces Act)",
      "RA 7877 (Anti-Sexual Harassment Act)",
      "Walang batas sa Pilipinas na sumasaklaw sa online na Pamimilit sa kasalukuyan"
    ],
  ...
  },
  {
    ...
    qTL:"Kung naging lugar ng pangungutya ang isang class group chat, ano ang makatwirang unang hakbang?",
    optionsTL:[
      ...
      "Walang magagawa tungkol sa online na Pambu-bully"
    ],
  ...
  },
  {
    ...
    qTL:"Sa sitwasyon ng buhay-estudyante, may taong pinipilit ng kasintahan na gumawa ng bagay na ayaw nito, na nagdudulot sa kaniya ng stress. Kung ang pamimilit ay mula sa karelasyon, aling batas ang maaaring umangkop dito?",
    optionsTL:[
      "RA 9262 (Anti-VAWC Law)",
      "RA 11313 (Safe Spaces Act)",
      "RA 7877 (Anti-Sexual Harassment Act)",
  ...
  },
  {
    ...
    qTL:"Tama o mali: kung sumang-ayon ang isang tao dahil lamang napipilitan, itinuturing pa rin itong isang uri ng pahintulot.",
    optionsTL:[
  ...
  },
  {
    ...
    qTL:"Kasama sa sitwasyon bilang saksi ang isang taong napapansin ang Pamimilit na hindi direktang nangyayari sa kanila. Paano naaangkop dito ang paraan ng Safe Spaces Act sa pananagutan?",
    optionsTL:[
      "Tanging ang taong direktang pinipilit lamang ang may gampanin",
      "Ang proteksyon ng batas ay saklaw lamang kapag nagsampa na ng pormal na reklamo ang biktima",
      "Ang Pamimilit ay itinuturing na kolektibong alalahanin ng komunidad, hindi lamang pribadong usapin sa pagitan ng dalawang tao",
      "Legal na kinakailangan ng mga saksi na direktang manghimasok"
    ],
    explainTL:"Itinuturing ng Safe Spaces Act ang gender-based harassment bilang usapin ng pananagutan ng buong komunidad, hindi lang isang pribadong alitan ng dalawang tao. Kaya mahalaga rin ang papel ng mga nakakasaksi—kahit hindi sila direktang makialam o komprontahin ang nangha-harass. Malaking bagay na ang pagre-report o pagsuporta sa taong nakaranas ng harassment."
  },
  {
    ...
    qTL:"Kung nasaksihan mong may hina-harass sa kampus, ano ang ligtas na paraan upang makatulong?",
    optionsTL:[
