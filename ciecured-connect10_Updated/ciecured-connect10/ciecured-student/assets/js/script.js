...
var TRANSLATIONS = {
  tl: {
    ...
    "hero.tracklinkb": "Subaybayan ito gamit ang iyong code.",
    ...
    "report.named": "May Pangalan",
    "report.name.label": "Pangalan",
    "report.name.placeholder": "Ano ang itatawag namin sa iyo?",
    ...
    "report.date.label": "Petsa at oras",
    ...
    "report.password.hint": "Kakailanganin mo ito, kasama ang iyong tracking code, upang mabasa ang mga sagot sa ibang pagkakataon. Hindi namin ito iniimbak bilang plain text, at hindi ito makikita o mare-reset ng staff para sa iyo — pakitandaan ito.",
    "report.submitbtn": "Isumite ang Report",
    "report.track.title": "May naiulat ka na ba?",
    "report.track.desc": "Ilagay ang iyong pribadong tracking code at password upang mabasa ang mga sagot o magdagdag ng detalye sa umiiral na kaso.",
    "report.track.code.label": "Tracking code",
    "report.track.code.placeholder": "hal. CIE-7X4K-92",
...
function submitReport(){
  ...
  var reportBody = 'code=' + encodeURIComponent(code) + '&category=' + encodeURIComponent(cat) + '&message=' + encodeURIComponent(desc || '(No description provided)') + '&password=' + encodeURIComponent(password) + '&location=' + encodeURIComponent(location) + '&incident_date=' + encodeURIComponent(incidentDate) + '&display_name=' + encodeURIComponent(displayName);
