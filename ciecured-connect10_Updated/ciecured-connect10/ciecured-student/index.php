    ...
    <div class="wrap hero-grid">
      ...
      <div class="hero-visual">
        ...
        <div class="hero-card">
          ...
          <a class="track-link" href="#" onclick="showPage(event,'inbox')"><span data-i18n="hero.tracklink">Already reported? </span><b data-i18n="hero.tracklinkb">Track it with your code.</b></a>
        </div>
      </div>
    </div>
  </section>
      ...
      <div class="report-box">
        <div>
          ...
          <div class="toggle-row">
            <button class="active" onclick="setMode(this)" data-i18n="report.anonymous">Anonymous</button>
            <button onclick="setMode(this)" data-i18n="report.named">Named</button>
          </div>

          <div class="field" id="nameField" hidden>
            <label for="displayName" data-i18n="report.name.label">Name</label>
            <input id="displayName" type="text" placeholder="What should we call you?" data-i18n-placeholder="report.name.placeholder">
          </div>
		 ...
		 <div class="field">
            <label for="incidentDate" data-i18n="report.date.label">Date and time</label>
          ...
          <div class="field">
            ...
            <p class="field-hint" data-i18n="report.password.hint">You'll need this, along with your tracking code, to read replies later. We don't store this as plain text, and staff can't see it or reset it for you — please remember it.</p>
          </div>
        ...
        <div class="track-box">
          ...
          <p data-i18n="report.track.desc">Enter your private tracking code and password to read replies or add details to an existing case.</p>
          <div class="field" style="margin-bottom:0;">
            <label for="code" data-i18n="report.track.code.label">Tracking code</label>
            <input id="code" type="text" placeholder="e.g. CIE-7X4K-92" data-i18n-placeholder="report.track.code.placeholder">
          </div>
          <div class="field" style="margin-bottom:0; margin-top:10px;">
            <label for="codePassword" data-i18n="report.track.password.label">Password</label>
            <input id="codePassword" type="password" placeholder="Your inbox password" data-i18n-placeholder="report.track.password.placeholder">
          </div>
