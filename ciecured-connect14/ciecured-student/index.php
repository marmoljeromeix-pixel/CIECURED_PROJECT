...
<link rel="stylesheet" href="assets/css/scenarios.css?v=<?php echo filemtime(__DIR__ . '/assets/css/scenarios.css'); ?>">
</head>
<body>
  ...
  <div class="scenario-card">
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        <span class="scenario-visual scenario-visual--square" aria-hidden="true">
      ...
      <div class="scenario-expand">
        <div class="scenario-expand-inner">
          <div class="scenario-expand-content scenario-expand-split">
			<span class="scenario-visual-secondary scenario-visual--square" aria-hidden="true">
...
<script src="assets/js/scenarios.js?v=<?php echo filemtime(__DIR__ . '/assets/js/scenarios.js'); ?>"></script>
