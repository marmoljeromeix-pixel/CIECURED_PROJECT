    ...
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        <span class="scenario-visual" aria-hidden="true">
          <img src="assets/img/Img_S1.1jpg" alt="">
        </span>
    ...
    <div class="wrap">
      <div class="awareness-grid">
        <div class="awareness-copy">
          ...
          <h2>Are you aware that<br>there are ways to <span class="accent">report your case?</span></h2>
    ...
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        ...
        <div class="scenario-main">
          ...
          <h3 class="scenario-title">What would you do if someone pressured you into something you didn't want?</h3>
  ...
  <section class="assess-hero">
    <div class="wrap">
      <div class="section-head" style="margin:0 auto 0; max-width:640px; text-align:center;">
        ...
        <p>Five quick questions — no wrong turns, just clarity. Nothing here is tracked or reported anywhere.</p>
      </div>
    </div>
  </section>
      ...
      <div class="quiz-shell">
        ...
        <div id="quizPlay">
          <div class="quiz-progress">
            ...
            <span class="quiz-progress-label" id="quizProgressLabel">Question 1 of 5</span>
          </div>
        ...
        <div id="quizResults" hidden>
          <div class="quiz-result-card">
            <span class="result-score" id="resultScore">0/5</span>
...
<div id="codeModal" class="modal-overlay" hidden>
  <div class="modal-box">
    ...
    <p>Take a screenshot or write this down — along with the password you just created.</p>
    <p class="field-hint">You'll need both, together, to check for replies later. We don't store your password as plain text, and staff can't look either of these up for you if you lose them.</p>
