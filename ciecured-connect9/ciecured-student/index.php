...
<header>
  <div class="wrap nav-inner">
    ...
    <nav class="links">
      <a href="#rights" data-page="home" class="active" onclick="goHome(event,'rights')">Know Your Rights</a>
      <a href="#" data-page="assess" onclick="showPage(event,'assess')">Assess Yourself</a>
      <a href="#" data-page="inbox" onclick="showPage(event,'inbox')">Inbox</a>
    </nav>
    <div class="nav-actions">
      <button class="btn btn-primary" onclick="goHome(event,'report')">Report</button>
  ...
  <div class="mobile-nav" id="mobileNav" hidden>
    <a href="#rights" onclick="closeMobileNav(); goHome(event,'rights')">Know Your Rights</a>
    <a href="#" onclick="closeMobileNav(); showPage(event,'assess')">Assess Yourself</a>
    <a href="#" onclick="closeMobileNav(); showPage(event,'inbox')">Inbox</a>
    <a href="#" onclick="closeMobileNav(); goHome(event,'report')">Report</a>
  </div>
</header>
...
<main id="top" class="page">
  ...
  <section class="hero">
    <div class="wrap hero-grid">
      <div>
        <span class="eyebrow"><span class="dot"></span>SAFE · CONFIDENTIAL · ACCOUNTABLE</span>
        <h1>Speak. Learn.<br><span class="accent">Stay Safe</span> — with CIEcured.</h1>
        <p class="sub">A safe and confidential space for CIE students to understand their rights, raise concerns, and take action—while staying in control of their story.  </p>
        <div class="hero-ctas">
          <button class="btn btn-hero" onclick="document.getElementById('report').scrollIntoView()">Report Now</button>
        ...
        <div class="trust-row">
          <span><span class="pip"></span>Anonymous or named</span>
          <span><span class="pip"></span>Tamper-evident record</span>
          <span><span class="pip"></span>Audited access only</span>
        </div>
      </div>
      ...
      <div class="hero-visual">
        ...
        <div class="hero-card">
          ...
          <p>Whatever brought you here, you're in control of what happens next.</p>
          <ul class="reassure-list">
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>
              Your identity stays in your control, always
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>
              Only trained, verified staff can review a case
            </li>
            <li>
              <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M20 6L9 17l-5-5"/></svg>
              Go at your own pace — nothing is rushed
            </li>
          </ul>
          <button class="btn btn-primary" onclick="goHome(event,'how')">See how it works</button>
          <a class="track-link" href="#" onclick="showPage(event,'inbox')">Already reported? <b>Track it with your code.</b></a>
        </div>
      </div>
    </div>
  </section>
    ...
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        ...
        <div class="scenario-main">
          <span class="scenario-label"><span class="pip"></span>In the classroom</span>
          <h3 class="scenario-title">What would you do if a classmate touched you without your consent?</h3>
          <p class="scenario-preview">During a classroom activity, a male student repeatedly touches a female classmate’s body parts even though she is uncomfortable with it. She moves away, but he does it again and says he is only joking. The student feels uneasy and is unsure whether she should report it.</p>
        </div>
      ...
      <div class="scenario-expand">
        <div class="scenario-expand-inner">
          <div class="scenario-expand-content scenario-expand-split">
			...
			<p class="scenario-meaning">The student should move away and seek help from someone she trusts, such as her teacher or a GAD representative. She can share what happened and report the behavior if she feels comfortable doing so. Through GAD, she can receive support and guidance while ensuring that her concern is handled respectfully and confidentially.</p>
    ...
    <div class="wrap">
      <div class="awareness-grid">
        <div class="awareness-copy">
          <span class="eyebrow">📣 SPEAK UP, SEEK SUPPORT</span>
          <h2>Are you aware that<br>there are Laws to <span class="accent">help your case?</span></h2>
          <p>You have the right to speak up and seek help. There are safe and appropriate channels available for you.</p>
          <a href="#rights" class="awareness-link" onclick="goHome(event,'rights')">Know your rights first →</a>
        </div>
        ...
        <div class="ways-grid">
          <div class="way-card">
            ...
            <h3>In Person</h3>
            <p>Seek assistance from the appropriate university office or authorized personnel.</p>
          </div>
          <div class="way-card">
            <div class="way-icon">
            ...
            <h3>Through Official Channels</h3>
            <p>Use existing school reporting procedures and support services.</p>
          </div>
          <div class="way-card way-card-accent">
            ...
            <h3>Through CIEcured</h3>
            <p>Submit and securely follow up on your report through our confidential platform.</p>
            <button class="btn btn-primary way-btn" onclick="goHome(event,'report')">Start a report</button>
          </div>
        </div>
      </div>
  ...
  <div class="scenario-card">
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        ...
        <div class="scenario-main">
          <span class="scenario-label"><span class="pip"></span>Within the faculty</span>
          <h3 class="scenario-title">What would you do if a professor crossed a personal boundary?</h3>
          <p class="scenario-preview">A position of authority should never be used to pressure or intimidate a student.</p>
        </div>
        <span class="scenario-indicator" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
        </span>
      ...
      <div class="scenario-expand">
        <div class="scenario-expand-inner">
          <div class="scenario-expand-content">
            <p class="scenario-meaning">Unwanted comments, messages, or pressure from someone with authority over you — a professor, adviser, or supervisor — is a misuse of that authority. It isn't something you caused.</p>
            <div class="scenario-grid">
              <div class="scenario-chip">
                <div class="chip-head">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M14.5 9.5L10 10l-.5 4.5L14 14l.5-4.5z"/></svg>
  ...
  <section id="rights">
    <div class="wrap">
      <div class="section-head">
        <span class="section-eyebrow">The law is already on your side.</span>
        <h2>Are You Aware of Your Rights?</h2>
        <p>CIEcured translates the protections you're entitled to into plain language — so you can recognize what's happening and know exactly what to do next.</p>
      </div>
      <div class="rights-grid">
        <div class="right-card" tabindex="0">
          <span class="law-tag">RA 9262</span>
          <h3>Anti-VAWC Law</h3>
          <span class="right-hint">Hover to learn more ›</span>
          <div class="right-detail">
            <p>Protects women and their children from physical, sexual, psychological, and economic abuse — including by a partner or family member.</p>
            <p class="right-extra">Applies to a spouse, ex-spouse, or partner — even without marriage or shared residence. Covers threats, controlling behavior, and withholding financial support, not just physical harm.</p>
          </div>
        </div>
        <div class="right-card" tabindex="0">
          ...
          <span class="right-hint">Hover to learn more ›</span>
          <div class="right-detail">
            <p>Covers harassment in streets, public spaces, online, and educational or workplace settings — gender-based, in any form.</p>
            <p class="right-extra">Includes catcalling, stalking, unwanted advances, and online harassment such as unwanted sexual remarks, threats, or sharing private content without consent.</p>
          </div>
        </div>
        <div class="right-card" tabindex="0">
          ...
          <span class="right-hint">Hover to learn more ›</span>
          <div class="right-detail">
            <p>Addresses harassment by someone who holds authority, influence, or moral ascendancy over you at school or at work.</p>
            <p class="right-extra">Covers a supervisor, teacher, or someone in a position of power who conditions a favor, grade, or job outcome on sexual demands — even implied ones.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="scenario-divider">
  <div class="scenario-card">
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        ...
        <div class="scenario-main">
          <span class="scenario-label"><span class="pip"></span>Online campus life</span>
          <h3 class="scenario-title">What would you do if your class group chat became a place for harassment?</h3>
          <p class="scenario-preview">Harassment can happen even when you're behind a screen.</p>
        </div>
        <span class="scenario-indicator" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
        </span>
      ...
      <div class="scenario-expand">
        <div class="scenario-expand-inner">
          <div class="scenario-expand-content">
            <p class="scenario-meaning">Unwanted messages, shared photos, or rumors in a class or org chat are still harassment — the fact that it happened online doesn't make it less real.</p>
            <div class="scenario-grid">
              <div class="scenario-chip">
                <div class="chip-head">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M14.5 9.5L10 10l-.5 4.5L14 14l.5-4.5z"/></svg>
  ...
  <section>
    <div class="wrap">
      <div class="section-head">
        <span class="section-eyebrow">Why CIEcured Is Trusted</span>
        <h2>Built so the record protects you, too.</h2>
        <p>Every safeguard exists for one reason: so raising your voice never puts you at more risk.</p>
      </div>
      <div class="trust-grid">
        <div class="trust-card">
          ...
          <h3>Confidential</h3>
          <p>Report with your name or completely anonymously — you're always in control of what you share.</p>
        </div>
        <div class="trust-card">
          <div class="icon-halo">
          ...
          <p>Every report and action writes to a hash-chained record that can be independently verified.</p>
        </div>
        <div class="trust-card">
          <div class="icon-halo">
          ...
          <p>Only named, trained staff can open a report — and every view is logged.</p>
        </div>
        <div class="trust-card">
          <div class="icon-halo">
          ...
          <p>Start a report any time. This isn't an emergency line — for immediate danger, call your local hotline.</p>
        </div>
      </div>
    </div>
  </section>
  ...
  <div class="scenario-card">
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        ...
        <div class="scenario-main">
          <span class="scenario-label"><span class="pip"></span>Student life</span>
          <h3 class="scenario-title">What would you do if someone pressured you into doing something you didn't want?</h3>
          <p class="scenario-preview">You never owe someone something because they're your friend, partner, classmate, or org member.</p>
        </div>
        <span class="scenario-indicator" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
        </span>
      ...
      <div class="scenario-expand">
        <div class="scenario-expand-inner">
          <div class="scenario-expand-content">
            <p class="scenario-meaning">Pressure, guilt-tripping, or "everyone's doing it" can make real consent hard to give freely. You can change your mind at any point, even after saying yes.</p>
            <div class="scenario-grid">
              <div class="scenario-chip">
                <div class="chip-head">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M14.5 9.5L10 10l-.5 4.5L14 14l.5-4.5z"/></svg>
    ...
    <div class="wrap">
      <div class="how-wrap">
        <div class="section-head" style="margin-bottom:44px;">
          <span class="section-eyebrow">⚙ How CIEcured Works</span>
          <h2>A simple and secure reporting process</h2>
          <p>We're here to listen, support, and help every step of the way.</p>
        </div>
        <div class="how-flow">
          <div class="how-flow-step">
            ...
            <h3>Submit</h3>
            <p>Share the details of the incident through our secure reporting form.</p>
          </div>
          ...
          <div class="how-flow-step">
            ...
            <h3>Review</h3>
            <p>Your report is received and carefully reviewed by authorized personnel.</p>
          </div>
          <div class="how-flow-connector"></div>
          <div class="how-flow-step">
            <div class="how-icon-circle">
            ...
            <h3>Communicate</h3>
            <p>You may receive questions or updates through the secure system.</p>
          </div>
          <div class="how-flow-connector"></div>
          <div class="how-flow-step">
            <div class="how-icon-circle">
            ...
            <h3>Follow Up</h3>
            <p>Use your case credentials to check updates and continue communication.</p>
          </div>
        </div>
      </div>
    </div>
...
<div class="scenario-divider">
  <div class="scenario-card">
    <article class="scenario-card-inner" tabindex="0" aria-expanded="false">
      <div class="scenario-row">
        ...
        <div class="scenario-main">
          <span class="scenario-label"><span class="pip"></span>As a bystander</span>
          <h3 class="scenario-title">What would you do if you witnessed someone being harassed on campus?</h3>
          <p class="scenario-preview">You don't have to be the person experiencing harassment to help create a safer campus.</p>
        </div>
        <span class="scenario-indicator" aria-hidden="true">
          <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.4" stroke-linecap="round" stroke-linejoin="round"><path d="M6 9l6 6 6-6"/></svg>
        </span>
      ...
      <div class="scenario-expand">
        <div class="scenario-expand-inner">
          <div class="scenario-expand-content">
            <p class="scenario-meaning">Noticing something is often the first step. You don't need to be certain, and you don't have to handle it alone — small actions can still make a real difference.</p>
            <div class="scenario-grid">
              <div class="scenario-chip">
                <div class="chip-head">
                  <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="12" r="9"/><path d="M14.5 9.5L10 10l-.5 4.5L14 14l.5-4.5z"/></svg>
  ...
  <section class="report-section" id="report">
    <div class="wrap">
      <div class="section-head">
        <span class="section-eyebrow">Report a Concern</span>
        <h2>Whenever you're ready, we're listening.</h2>
      </div>
      <div class="report-box">
        <div>
          <h3>Submit a report</h3>
          <p class="desc">This takes about three minutes. You can stop and save a draft at any point.</p>

          <div class="toggle-row">
            <button class="active" onclick="setMode(this)">Anonymous</button>
            <button onclick="setMode(this)">Named</button>
          </div>

          <div class="field" id="nameField" hidden>
            <label for="displayName">Name</label>
            <input id="displayName" type="text" placeholder="What should we call you?">
          </div>
          ...
          <div class="field">
            ...
            <select id="cat">
              ...
              <option>Physical or emotional abuse</option>
              <option>Online / digital harassment</option>
              <option>Other safeguarding concern</option>
            </select>
          </div>
		 ...
		 <div class="field">
          ...
          <div class="field">
            ...
            <input id="location" type="text" placeholder="e.g. Room 204, CR, hallway…">
          </div>
			
          <div class="field">
            <label for="desc">What's happening</label>
            <textarea id="desc" placeholder="Share as much or as little as you're comfortable with…"></textarea>
          </div>

          <div class="field">
            <label for="reportPassword">Create an inbox password</label>
            <input id="reportPassword" type="password" placeholder="At least 4 characters">
            <p class="field-hint">You'll need this, along with your tracking code, to read replies later. We don't store this as plain text, and staff can't see it or reset it for you — please remember it.</p>
          </div>

          <button class="btn btn-primary" style="padding:13px 26px;" onclick="submitReport()">Submit Report</button>
        </div>

        <div class="track-box">
          <h3>Already reported?</h3>
          <p>Enter your private tracking code and password to read replies or add details to an existing case.</p>
          <div class="field" style="margin-bottom:0;">
            <label for="code">Tracking code</label>
            <input id="code" type="text" placeholder="e.g. CIE-7X4K-92">
          </div>
          <div class="field" style="margin-bottom:0; margin-top:10px;">
            <label for="codePassword">Password</label>
            <input id="codePassword" type="password" placeholder="Your inbox password">
          </div>
          <button class="btn btn-outline" style="margin-top:14px; width:100%;" onclick="trackReport()">Open Inbox</button>
  ...
  <section class="assess-hero">
    <div class="wrap">
      <div class="section-head" style="margin:0 auto 0; max-width:640px; text-align:center;">
        <span class="section-eyebrow">🧭 Assess Yourself</span>
        <h2>How well do you know your rights?</h2>
        <p>Ten quick questions — no wrong turns, just clarity. Nothing here is tracked or reported anywhere.</p>
      </div>
    </div>
  </section>
        ...
        <div id="quizResults" hidden>
          <div class="quiz-result-card">
            ...
            <div class="result-ctas">
              <button class="btn btn-hero" onclick="goHome(event,'report')">Report a concern</button>
              <button class="btn btn-outline" onclick="goHome(event,'rights')">Review your rights</button>
              <button class="btn btn-outline" onclick="startQuiz()">Retake assessment</button>
            </div>
          </div>
        </div>
  ...
  <section class="inbox-body" id="inboxLockedSection" style="padding:60px 0;">
    <div class="wrap" style="display:flex; justify-content:center;">
      <div class="modal-box" style="max-width:420px;">
        ...
        <p>Enter your tracking code and password to continue.</p>
        <div class="field" style="text-align:left;">
          <label for="inboxCode">Tracking code</label>
          <input id="inboxCode" type="text" placeholder="e.g. CIE-7X4K-92">
        </div>
    ...
    <div class="wrap" style="max-width:640px;">
      ...
      <div class="inbox-thread" id="inboxThread">
        <div class="thread-header">
          ...
          <span class="thread-cat" id="threadDate"></span>
        </div>
...
<div id="codeModal" class="modal-overlay" hidden>
  <div class="modal-box">
    <h3>Save this now — before you close this window</h3>
<div class="code-display" id="modalCodeValue">CIE-XXXX-XX</div>
<p>Screenshot this code or write it down somewhere you'll remember right away — along with the password you just created.</p>
<p class="warning-highlight">Your inbox is kept private and confidential using this code and password together. If you lose either one, there is no way to recover it — not even our staff can look it up or reset it for you, and you will not be able to get back into this conversation.</p>
    <button class="btn btn-primary" style="width:100%; margin-top:6px;" id="modalOpenInboxBtn">I've saved it — open my inbox</button>
    <button class="btn btn-outline" style="width:100%; margin-top:10px;" onclick="closeCodeModal()">Close</button>
  </div>
</div>
